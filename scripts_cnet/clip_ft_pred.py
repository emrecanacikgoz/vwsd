...
@hydra.main(version_base=None, config_path=CONFIG_DIR, config_name="clip_ft_cnet_validate")
def main(config):
    ...
    if not load:
        ...
        experiment = Experiment.load_from_checkpoint("/kuacc/users/oince22/vwsd/scripts_google/checkpoints/epoch=9-step=28960.ckpt")
